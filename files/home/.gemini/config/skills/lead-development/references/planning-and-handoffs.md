...
Use the phase model from SKILL.md. Create explicit bounded subagents with
the necessary facts instead of relying on unavailable conversation inheritance.
Check the tool schema and actual allowed model identifiers.
